                ...
                <div class="signmodal-content">
                    ...
                    <form action="Login" method="POST">
                        ...
                        <div class="signmodal-footer">
                            <input type="hidden" name="path" value="/HomeProduct">
...
<!--Body Container-->
        ...
        <div class="container">
            ...
            <br>username
            <br> <input type="text" name="username" placeholder="Your first name.." required>
            <br>password
            <br> <input type="password" name="password" placeholder="Your last name.." required>
            <br>firstname
            <br> <input type="text" name="firstname" placeholder="Your user name.." required>
            <br>lastname
            <br> <input type="text" name="lastname" placeholder="Your password name.." required>
            <br>email
            <br> <input type="email" name="email" placeholder="Your email name.." required>
            <br><span style="color: coral" > ${errorRegis} </span>
                 </div>
                    
                        <input class="butn submit-button" type="submit" name="" value="Sign Up">
