<%-- 
    Document   : RoseProducts
    Created on : Nov 14, 2018, 5:02:00 PM
    Author     : Miki
--%>
...
<a href="HomeProducts"><img class="img-logo" src="img/logo-01.png"></a>
        ...
        <form action="Logout" method="POST">
            <input type="hidden" name="path" value="/RoseProducts">
...
<div class="col-12">
    <div class="row-text-center">
        <form action="RoseProducts" method="post">
            ...
            <input type="image" src ="imgWine/wine/p33.png" width="100%" >
        </form>      
    </div>
</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">                                      
                                                ...
                                                <form action="AddItemToCart" method="post">
                                                    <input type="hidden" value="/RoseProducts" name="pathproduct">
