<%-- 
    ...
    Created on : Nov 29, 2018, 11:02:09 PM
    Author     : Chutikan
--%>
    ...
    <div class="col-12" style=" width: 100%;">
        <div class="row">
            <div class="col-6" style=" width: 50%;float: left" >
                <p><img src="imgWine/wine/${ProductChoose.productcode}.jpg" width="500" border="1"></p>
            </div>
            <div class="col-6" style=" width: 50%;float: left;margin-top: 60px;font-size: 23px;">                                     
                <p>${ProductChoose.productname}</p>
                <p>${ProductChoose.type}</p>
                <p>${ProductChoose.capacity}</p>
                <p>${ProductChoose.vintage}</p>
                <p>${ProductChoose.grape}</p>
                <p>฿ ${ProductChoose.price}</p>
                <p><input type="button" class="butn" value="Add to cart"/></p>
            </div>
        </div>
    </div>
</div>
