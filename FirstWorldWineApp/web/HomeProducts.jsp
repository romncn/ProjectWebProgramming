<%-- 
    ...
    Created on : Nov 15, 2018, 4:16:27 PM
    Author     : Miki
--%>
...
<html>
        ...
        <div class="row-text-center">
            <div class="zoom">
                <form action="AllProducts" method="post">
                    ...
                    <input type="image" src ="imgWine/wine/p11.png" width="100%" >
                </form>  
            </div>
        </div>
    </div>
            ...
            <div class="col-6" style=" padding: 0px;margin: 0px;">
                <div class="zoom" >
                    <form action="RedProducts" method="post">
                        ...
                        <input type="image" src ="imgWine/wine/p22.png" width="98%">
                    </form>
                </div>
            </div>
            <div class="col-6"  style=" padding: 0px;margin: 0px;">
                <div class="zoom">
                    <form action="WhiteProducts" method="post">
                        <input type="hidden" value="WHITE" name="type">
                        <input type="image" src ="imgWine/wine/p44.png" width="98%" >
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-6" style=" padding: 0px;margin: 0px;">
                <div class="zoom">
                    <form action="RoseProducts" method="post">
                        <input type="hidden" value="ROSE" name="type">
                        <input type="image" src ="imgWine/wine/p33.png" width="98%" >
                    </form>
                </div>
            </div>
            <div class="col-6" style=" padding: 0px;margin: 0px;">
                <div class="zoom">
                    <form action="SparklingProducts" method="post">
                        <input type="hidden" value="SPARKLING" name="type">
                        <input type="image" src ="imgWine/wine/p55.png" width="98%">
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="col-4">             
                    ...
                    <form action="Filter" method="post">
                        <div class="block-filter">
                            ...
                            <br>
                            <br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="butn" value="search" style=" padding: 3.2px 5px;margin-left: -20px;">  
                        </div>
                    </form>
                            ...
                            <c:forEach items="${Product}" var="p" varStatus="vs">
                                <div class="col-6 p-3">
                                    <a href="ShowProducts?namechoose=${p.productcode}" style="text-decoration: none;color: #02111b">
                                        <div style="background-color: white;border-radius: 8px;padding-top: 12px;"> 
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-6" >
                                                    ...
                                                    <div class="col-6">                                      
                                                        ...
                                                        <form action="AddItemToCart" method="post">
                                                            <input type="hidden" value="/HomeProducts" name="pathproduct">
