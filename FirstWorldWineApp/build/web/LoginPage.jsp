<%-- 
    Document   : LoginPage
    Created on : Nov 16, 2018, 11:20:47 AM
    Author     : ROM
--%>
...
<html>
                ...
                <div class="signmodal-content">
                    ...
                    <form action="Login" method="POST">
                        ...
                        <div class="signmodal-footer">
                            <input type="hidden" name="path" value="/HomeProducts">
                            <input type="hidden" name="checkHis" value="${account}">
    ...
    <div class="container" style="margin-left: 260px">
        <form action="Login" method="POST">
            <div class="signmodal-body" style="font-size: 26px">

                username 
                <br><input type="text" name="username" size="30" required>
                <br>
                password 
                <br><input type="password" name="password" size="30" required>

                <br> <span style="font-size: 23px;margin-left: 260px;">If you didn't have an account? &nbsp;<a href="SignUpPage" style="color: #848fa5;">Sign up</a>
                </span>
                <br><span style="font-size: 20px;text-align: center;color: coral;margin-left: 290px;">${errorIn}</span>
            </div>
            <div class="signmodal-footer">
                <input type="hidden" name="path" value="${checklogin}">
                <input type="submit" name="submit" class="butn signin-button" data-dismiss="modal" value="Sign In" style="margin-right: 592px;">
            </div>
        </form>
    </div> 
