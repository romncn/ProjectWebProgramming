<%-- 
    Document   : SparklingProducts
    Created on : Nov 14, 2018, 5:02:37 PM
    Author     : Miki
--%>
...
<div class="col-12">
    <div class="row-text-center">
        <form action="SparklingProducts" method="post">
            ...
            <input type="image" src ="imgWine/wine/p55.png" width="100%" >
        </form>      
    </div>
</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">                                      
                                                ...
                                                <form action="AddItemToCart" method="post">
                                                    <input type="hidden" value="/SparklingProducts" name="pathproduct">
